...
class DesktopProvisioner(
    ...
    fun provisionBase(
        ...
        normalizeStagedDebArchitectures(rootfs)
    ...
    private fun normalizeStagedDebArchitectures(rootfs: File) {
        runChecked(
            rootfs,
            """
            set -e
    ...
    private data class PackageGroup(
        ...
        val packages: String,
                        ...
                        sed -i 's/^Architecture:[[:space:]]*aarch64[[:space:]]*${'
            """.trimIndent(),
        )
    }
    private fun installPinnedDesktopStack(rootfs: File) {
